...
public class Controllers {
	...
	/**
	 * 내부 화면 간의 전환을 위해 User_Home 컨트롤러에 load된 내부 화면의 참조를 다른 컨트롤러들의 필드에 저장 시킴
	 */
	...
	public static void sweeper(Pane previous) {
		for (Node target : previous.getChildren()) {
			if (target instanceof Button) continue;
	 ...
	 */
	public static void switchView(Pane pane, User_Home cont) {
